...
<html>
<head>
<title>CLASS 1st Details(22-23)</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<!-- main content start-->
		<?php
$view = mysqli_query($connect,"select * from admission_form where class='1st' and DOA='2023-06-16' order by
...
?>
  ...
  <table class="table" >
    ...
    <thead> 
						...
						href="class1_2223_update.php?stud_id=<?php echo $Id;?>"
						...
						href="class1_2223_delete.php?stud_id=<?php echo $Id;?>"
