...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<!-- main content start-->
		<?php
$view = mysqli_query($connect,"select * from admission_form where class='3rd' and DOA='2022-06-16' order by
...
?>
    ...
    <thead> 
						...
						href="class3_update.php?stud_id=<?php echo $Id;?>"
						...
						href="class3_delete.php?stud_id=<?php echo $Id;?>"
