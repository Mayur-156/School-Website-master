...
include 'connect.php';
    ...
    $asd ="insert into admin(Firstname,Lastname,Email,Password,New_password,Gender) 
    values('$FN','$LN','$Email','$Password','$New_password','$Gender')"; 
        ...
        {
        echo "<script>;";
        echo "window.alert('Signup successful');";
